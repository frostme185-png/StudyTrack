...
// sub-ranks (I-IV), tier 6 ("Eternal") is a single capstone rank with no
...
const LEVELS = [
  { lvl: 1,  hours: 0,   title: 'Sprout I' },
  { lvl: 2,  hours: 3,   title: 'Sprout II' },
  { lvl: 3,  hours: 6,   title: 'Sprout III' },
  { lvl: 4,  hours: 10,  title: 'Sprout IV' },
  { lvl: 5,  hours: 15,  title: 'Student I' },
  { lvl: 6,  hours: 22,  title: 'Student II' },
  { lvl: 7,  hours: 30,  title: 'Student III' },
  { lvl: 8,  hours: 40,  title: 'Student IV' },
  { lvl: 9,  hours: 50,  title: 'Diligent I' },
  { lvl: 10, hours: 65,  title: 'Diligent II' },
  { lvl: 11, hours: 80,  title: 'Diligent III' },
  { lvl: 12, hours: 100, title: 'Diligent IV' },
  { lvl: 13, hours: 125, title: 'Elite I' },
  { lvl: 14, hours: 150, title: 'Elite II' },
  { lvl: 15, hours: 180, title: 'Elite III' },
  { lvl: 16, hours: 220, title: 'Elite IV' },
  { lvl: 17, hours: 260, title: 'Legend I' },
  { lvl: 18, hours: 310, title: 'Legend II' },
  { lvl: 19, hours: 370, title: 'Legend III' },
  { lvl: 20, hours: 450, title: 'Legend IV' },
  { lvl: 21, hours: 550, title: 'Eternal' },
]

const BADGES = [
  { id: 'hours-10',       kind: 'hours',       threshold: 10,  label: '10 Hours Studied' },
  { id: 'hours-50',       kind: 'hours',       threshold: 50,  label: '50 Hours Studied' },
  { id: 'hours-100',      kind: 'hours',       threshold: 100, label: '100 Hours Studied' },
  { id: 'hours-500',      kind: 'hours',       threshold: 500, label: '500 Hours Studied' },
  { id: 'streak-7',       kind: 'streak',      threshold: 7,   label: '7-Day Streak' },
  { id: 'streak-30',      kind: 'streak',      threshold: 30,  label: '30-Day Streak' },
  { id: 'streak-100',     kind: 'streak',      threshold: 100, label: '100-Day Streak' },
  { id: 'first-session',  kind: 'sessions',    threshold: 1,   label: 'First Step' },
  { id: 'multi-site-day', kind: 'multisite',   threshold: 3,   label: 'Multitasker' },
  { id: 'perfect-week',   kind: 'perfectweek', threshold: 1,   label: 'Perfect Week' },
]
